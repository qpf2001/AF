...
<html lang="en">
  ...
  <body>
    ...
    <!--头部结束 -->
        ...
        <div class="classification-top">
            <a href="/all product/11.html" target="blank">所有分类</a>
            <span>&gt;</span>
            <input type="text" value="在当前结果搜索" id="text_2" />
            <div class="triangle"></div>
              <div class="img-fl">
              <img src="/images/fsj.png" alt="">
            </div>
        </div>
        <div class="all_sort center">
            <table cellspacing="0">
                <tr>
                    <td style="width: 100px;" align="center">细分风格</td>
                    <td style="width: 1100px;">
                        <a href="#">商务休闲</a>
                        <a href="#">商务正装</a>
                        <a href="#">青春活力</a>
                        <a href="#" class="last_a">+ 多选</a>
                    </td>
                </tr>
                <tr>
                    <td align="center">衣长</td>
                    <td>
                        <a href="#">常规</a>
                        <a href="">中长款</a>
                        <a href="#">短款</a>
            ...
            <div class="sort_bot">
                <ul>
                    ...
                    <li>
                        <input type="checkbox" />
                        <span class="vip">店铺VIP商品</span>
                    </li>
                    <li>
                        1/3 <span>&lt;</span><span>&gt;</span>
                    </li>
                </ul>
            </div>
        </div>
  ...
  <div class="trousers center">
    <div class="same-list">
      ...
      <ul>
        <li>
          <div class="x-top">
            <a href="/trousers/15.html">
              <img src="/images/xk3.png" alt="" />
            </a>
          </div>
          <div class="x-bot">
            <p>
  ...
  <div class="short-t center">
    <div class="same-list">
      ...
      <ul>
        <li>
          <div class="x-top">
            <a href="/short-t/17.html">
              <img src="/images/dx1.jpg" alt="" />
            </a>
          </div>
          <div class="x-bot">
            <p>
  ...
  <!--饰品模块开始 -->
  <div class="return-top center"><a href="/all product/11.html">点击返回顶部</a></div>
  <!-- 底部模块开始 -->
    <footer>

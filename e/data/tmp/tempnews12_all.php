    ...
    <!-- 分类导航 -->
          <div class="same-list center">
            <ul>
                   <li>
    <div class="x-top">
        <a href="/Commodity-details/20.html"><img src="/images/time.jpg" alt="" /></a>
    </div>
    <div class="x-bot">
        <p>
            <a href="/Commodity-details/20.html">
                冬季新款商务休闲西服套装男士
                <br />
                职业修身羊毛西装
            </a>
...
<li>
    <div class="x-top">
        <a href="/Commodity-details/20.html"><img src="/images/time2.jpg" alt="" /></a>
    </div>
    <div class="x-bot">
        <p>
            <a href="/Commodity-details/20.html">
...
<li>
    <div class="x-top">
        <a href="/Commodity-details/20.html"><img src="/images/time1.jpg" alt="" /></a>
    </div>
    <div class="x-bot">
        <p>
            <a href="/Commodity-details/20.html">
...
<li>
    ...
    <div class="x-bot">
        ...
        <p>
            ...
            <div class="return-top center"><a href="/suit/2020-12-12/13.html">点击返回顶部</a></div>
              <!-- 底部模块开始 -->
    <footer>
